...
void q0 (){
	...
	cout << "Result: " <<dummy*3.0 << endl;
	cout << "Expected result: 800000" << endl;
...
void q5 (){
	...
	s.AddAtt(relName[1], "o_orderdate",15);
	...
	double result = s.Estimate(final, relName, 3);
	cout << "Result: " << result << endl;
	cout << "Expected answer: 400081" << endl;
...
//	s.Read(fileName);
	...
	s.AddAtt(relName[1], "l_receiptdate", 500);
...
//	s.Read(fileName);
	...
	s.AddAtt(relName[1], "o_orderkey",1500000);
	s.AddAtt(relName[1], "o_custkey",150000);
	s.AddAtt(relName[1], "o_orderdate", 500);
